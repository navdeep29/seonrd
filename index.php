...
<html>
    ...
    <body>
      <div class="header-container navbar navbar-fixed-top" >
            <div class="container">
        ...
        <div class="content3" id="about-section">
            <div class="container">
                <div class="row centered row col-md-10 col-md-offset-1">
                    <h3>ABOUT</h3>
                </div>
        ...
        <div class="content4" id="client-section">
            <div class="container">
               <div class="row centered"> 
                   <h3>OUR CLIENTS</h3>
               </div>
         ...
         <div class="content5" id="contact-section">
             <div class="content5i"
            <div class="container">
                <div class="row centered">
